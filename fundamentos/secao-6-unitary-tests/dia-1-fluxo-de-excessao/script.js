...
// Boletim escolar
// const verifyAverage = (n1, n2, n3, n4) => {
...
// const CalcAverage = (n1, n2, n3, n4) => {
//   let sum = n1 + n2 + n3 + n4;
//   let average;
//   try {
//     verifyAverage(n1, n2, n3, n4);
//     for (let index = 0; index < CalcAverage.length; index += 1) {
//       average = sum / CalcAverage.length;
//       return average;
//     }
//   }
//   catch (error) {
...
//   }
// }
// console.log(CalcAverage(5, 8, 10, '6'));